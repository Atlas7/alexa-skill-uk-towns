...
var APP_ID = "amzn1.ask.skill.1fafe3b1-decd-4014-a6c3-817c55154d30";
...
{
    var sentence = item.townName + " is a town within the county " + item.countyName + ". Which other town would you like to know about?";
    return sentence;
}
...
{
    return "Here is your " + counter + "th question.  In which county does the town " + item.townName + " belong to?";
...
function getAnswer(property, item)
{
    ...
    {
        case "Abbreviation":
            return "The " + formatCasing(property) + " of " + item.townName + " is <say-as interpret-as='spell-out'>" + item[property] + "</say-as>. "
        break;
        default:
            return "The " + formatCasing(property) + " of " + item.townName + " is " + item[property] + ". "
        break;
    }
}
...
var HELP_MESSAGE = "I know lots of things about the UK Towns.  You can ask me about a town, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?";
...
//This is what your card title will be.  For our example, we use the name of the town the user requested.
function getCardTitle(item) { return item.townName;}
...
function getSmallImage(item) { return "images/uk_flag_720px_x_400px.png"; }

//This is the large version of the card image.  It should be 1200x800 pixels in dimension.
function getLargeImage(item) { return "images/uk_flag_1200px_x_800px.png"; }
